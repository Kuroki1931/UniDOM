...
BASE_DIR = '/root/ExPCP/policy/data/Pinch_500_10500_0.2_0.4_200_200/full/2023-08-08_17-42'
...
def load_dataset(in_file, batch_size):
    ...
    def _preprocess_fn(sample):
        ...
        return goal_point, parameters, action
...
def train(args):
    ...
    model.build([(args.batch_size, 2), (args.batch_size, 2)])
    print(model.summary())
