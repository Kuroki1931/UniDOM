...
BASE_DIR = '/root/ExPCP/policy/data/Rollingpin_200_2000_200_2000_20_500/2023-05-14_01-42'
...
def train(args):
    ...
    for epoch in range(args.epoch):
            ...
            for i in tqdm(range(50)):
                ...
                for t in range(args.num_steps):
                    ...
                    if t % 5 == 0:
                        ...
                        I1.text((5, 5), f'last_{mu:.2f},lam{lam:.2f},yield_stress{yield_stress:.2f}', fill=(255, 0, 0))
                        imgs.append(pimg)
        ...
        if sum_last_iou > best_iou_sum:
            best_iou_sum = sum_last_iou
            model.save_weights(f'{exp_dir}/model/best_weights.ckpt')
        log_string('sum_last_iou: %4f' % sum_last_iou)
